...
export const scienceEvidenceByMessage: Record<string, ScienceEvidence> = {
  ...
  "sauce-5": { summary: "充分混合能让盐、曲和水分分布更均匀，减少局部过咸、过干或污染风险。装填与封闭会改变氧气和微生物环境，但“半瓮难熟”的程度仍与容器、温度和含水量有关。原文中的“面向太岁”属于古代岁时方位观念，目前没有现代科学证据证明它会影响酱的发酵或品质，应视为历史记载而非现代科学结论。", explanation: "用力揉到“润彻”，目的不是越狠越好，而是让盐、曲和水分真正走到每一处。若一团太咸、一团太干，微生物和酶的工作速度就会参差不齐，还可能留下容易坏的角落。装瓮后压紧、封好，也是在尽量稳定水分和气体环境。古人说半瓮难熟，可能与空隙、温度波动和水分散失有关，但不能简单理解为瓮越满越安全；现代制作仍要给发酵状态和产气留下合适空间。至于原文要求拌料、入瓮时“面向太岁”，这是古代传统观念或经验性做法，目前没有现代科学证据证明该方位仪式会影响酱的发酵或品质；不要用现代科学去解释“太岁”为什么能够影响发酵。它应被理解为《齐民要术》中的历史记载，而不是现代科学结论。", sourceIds: ["soy-fermentation-review", "soy-koji"] },
  ...
  "sauce-8": { summary: "原文把酱变坏归因于妊娠妇人，并以白叶棘子、孝杖搅酱、炙瓮或新汲水分酱来“救酱”。这些都属于古代经验或民俗观念，目前没有可靠现代科学证据证明上述因果关系。", explanation: "这一节应先当作《齐民要术》保存下来的历史记载来读，而不是现代科学结论。发酵会不会变坏，现代依据主要是盐度、水分、温度、卫生条件和微生物生态；目前没有可靠证据证明“妊娠妇人”本身会导致酱变坏，也没有证据证明把白叶棘子放入瓮中、用孝杖搅酱或炙瓮，就能让坏酱恢复正常。向人分酱时掺一盏新汲水，同样缺乏被验证的因果机制。不要用现代科学去强行解释这些做法为什么“有效”。🟠 古今知识注释：以上说法是古代传统经验或民俗性解释，目前缺乏现代科学证据支持。", sourceIds: ["soy-fermentation-review"] },
  "sauce-9": { summary: "肉、鱼和豆类发酵的原料、盐度、温度及优势微生物并不相同，不能因都叫“酱”就视作同一安全工艺。古人选择冬季可能利用低温降低腐败和虫害风险，但现代制作仍需独立的食品安全控制。", explanation: "豆酱、肉酱、鱼酱都叫“酱”，里面发生的事却并不一样：原料的蛋白质、脂肪和含水量不同，需要的盐度、温度和优势微生物也会变化。古人偏爱十二月制作，很可能是在借冬季低温压住腐败速度和虫害，为长时间发酵争取安全窗口。但低温并不能替代卫生控制。今天若复原肉酱或鱼酱，不能只凭豆酱经验类推，必须分别考虑原料处理、盐度、温度和食品安全。", sourceIds: ["soy-fermentation-review", "soy-chemistry-review"] }
};
