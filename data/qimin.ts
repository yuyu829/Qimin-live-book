  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: "sauce-8",
        speakerId: "jia",
        translation: "《术》说：若酱因妊娠妇人而坏，把白叶棘子放入瓮中，就会转好。俗人用孝杖搅酱、或烤炙酱瓮，酱或许能回头，却可能伤及胎儿。向人讨酱或分酱时，用一盏新汲的水和了再给，据说这样酱才不会坏。",
        original: "《術》曰：「若為妊娠婦人壞醬者，取白葉棘子著甕中，則還好。俗人用孝杖攪醬，及炙甕，醬雖迴而胎損。乞人醬時，以新汲水一盞，和而與之，令醬不壞。」",
        terms: [{ word: "妊娠婦人", category: "古代生育称谓" }, { word: "白葉棘子", category: "植物材料" }, { word: "新汲水", category: "新打的水" }]
      },
      {
        id: "sauce-9",
        speakerId: "jia",
